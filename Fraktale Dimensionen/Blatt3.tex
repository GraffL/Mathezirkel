...
\emph{Tipp:} Strecken sind eindimensionale Objekte, Flächen sind zweidimensionale Objekte und Volumen sind dreidimensional.\footnote{Punkt ist 0-dimensional - wie passt das in dieses Schema?}
\end{aufgabe}
...
\begin{aufgabe}{}
	...
	Kannst du außerdem die fraktale Dimension dieses Baumes bestimmen? Dazu kannst du zum Beispiel versuchen wieder eine Tabelle wie in \Cref{aufgabe:Wie_oft} auszufüllen:
	\begin{center}
		\renewcommand{\arraystretch}{2}
		\begin{tabular}{l||c|c|c|c}
			Streckfaktor:& $2$-fach & $3$-fach & $4$-fach & $9$-fach \\\hline\hline
...
\begin{aufgabe}{Pascalsches Dreieck}
	...
	Kannst du die folgende Figur so mit Zahlen befüllen, dass das Pascalsche Dreieck entsteht? (in jedem der Sechsecke soll also eine Zahl stehen und in jeder Zeile steht im linken und im rechten Sechseck eine $1$):
	\begin{center}
...
\begin{aufgabe}{}
	Kannst du den nächsten Schritt in dieser Konstruktion zeichnen? Kannst du die Dimension von diesem Objekt bestimmen? Kannst du dir vorstellen, was es bedeutet, dass das Objekt diese Dimension hat?
	
	(es hat Dimension 2 - und ist flächenfüllend)
\end{aufgabe}

\subsection{evtl. Fraktale im echten Leben}
