...
\begin{aufgabe}{}
% Eigentlich war diese Aufgabe so gedacht, dass man als Invariante die Summe aller 8 Zahlen verwenden kann. (was evtl. etwas leichter zu finden wäre)
% In der momentanen Form des Spiels ist dies aber keine Invariante.	
% Um dies zu reparieren könnte man das Spiel so abändern, dass statt a+b und a-b, 2a-b und 2b-a gebildet werden. 
% Alternativ floor((a+b)/2) und ceiling((a+b)/2)
